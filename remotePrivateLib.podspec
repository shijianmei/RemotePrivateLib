...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of remotePrivateLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shijianmei0@sina.com/remotePrivateLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shijianmei0@sina.com' => 'shijianmei0@sina.com' }
  s.source           = { :git => 'https://github.com/shijianmei0@sina.com/remotePrivateLib.git', :tag => s.version.to_s }
